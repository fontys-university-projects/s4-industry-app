<template>
  <div class="h-[calc(100vh-(130px+124px))] md:h-[calc(100vh-(130px+64px))]">
    <div class="relative isolate overflow-hidden pt-14">
      <div class="bg-gray-900">
        <img
          src="https://industry-api.fhict-dev.com/assets/24c2eb98-9c16-4e9e-8416-f01be1c4a6ca"
          alt=""
      ...
      >
        <div
          class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#a4907c] to-[#a4907c] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div class="text-center">
          <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">
            Welcome to the Stolpersteine app
          </h1>
