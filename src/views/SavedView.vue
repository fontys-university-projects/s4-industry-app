                        ...
                        <DialogPanel
                            ...
                            <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                                <button type="button"
                                        ...
                                        @click="open = false, removeStone(stone.id)">Remove</button>
                                <button type="button"
...
export default {
    ...
    methods: {
        ...
        async removeStone(id) {
            ...
            const parsed = myArray.join(',')
            await axios
            .get("https://industry-api.fhict-dev.com/items/stones?filter[id][_in]="+ parsed + "&fields=*,location.name,location.city.name")
